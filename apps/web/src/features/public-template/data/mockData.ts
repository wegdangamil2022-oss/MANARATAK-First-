...
export const MANARATAK_NATIVE_COURSES: Course[] = [
  {
    id: 'c1',
    ...
    progressPercent: 0,
    courseContent:
      'دورة عملية متكاملة تساعد الطالب على فهم عالم المنح الدراسية والقبولات الجامعية، والبحث عن الفرص المناسبة، وتجهيز ملف تقديم احترافي، والتقديم والمتابعة بنفسه، ثم التعامل مع المقابلات والنتائج والتأشيرة والاستعداد للسفر والدراسة في الخارج. وتشمل الدراسة فيديوهات مسجلة، وملفات تدريبية، واختبارات، وتطبيقات عملية.',
    courseModules: [
      {
        title: 'فهم المنح الدراسية والقبولات وتجهيز خطة التقديم',
        description:
          'فهم الفرق بين المنح الدراسية والقبولات الجامعية، ومنح التبادل الثقافي، ومتطلبات المنح الدراسية، والأسئلة الشائعة للمحاضرة الأولى، والمرفقات، واختبار المحاضرة الأولى.',
      },
      {
        title: 'البحث عن المنح والجامعات واختيار الفرص المناسبة',
        description:
          'تعلم طرق البحث عن المنح والجامعات والتخصصات، وتقييم ملف الطالب وفق المعدل واللغة والتخصص والخبرات والإمكانات، ثم إنشاء قائمة بالفرص المستهدفة ووضع استراتيجية واضحة للتقديم بدل التقديم العشوائي.',
      },
      {
        title: 'تقوية ملفك بالشهادات والدورات والأنشطة الداعمة',
        description:
          'اختيار الدورات والشهادات المرتبطة بالتخصص، والاستفادة من منصات التعليم والدورات ذات الشهادات المجانية، إلى جانب تجهيز وعرض الأنشطة التطوعية والمشاريع والمسابقات والبحث العلمي والخبرات بطريقة تقوي ملف التقديم.',
      },
      {
        title: 'كتابة الخطابات والوثائق التي تصنع الفرق في طلبك',
        description:
          'إعداد خطاب النية، وخطة الدراسة، والمقترح البحثي، وخطابات التوصية، وفهم وظيفة كل وثيقة وكيفية جعل جميع أجزاء الملف متكاملة دون تكرار نفس المعلومات.',
      },
      {
        title: 'الاختبارات والسيرة الذاتية وتجهيز الملفات باحترافية',
        description:
          'فهم اختبارات اللغة والاختبارات الأكاديمية مثل IELTS وTOEFL وPTE وSAT وGRE وGMAT، وتحديد الاختبار والدرجة المناسبة، وإعداد السيرة الذاتية الأكاديمية وEuropass، وترجمة وتصديق الوثائق، ومراجعة تطابق البيانات، وتجهيز الملفات بصيغة PDF مناسبة للتقديم الإلكتروني.',
      },
      {
        title: 'المراسلات والتقديم والمتابعة باحتراف',
        description:
          'مراسلة الجامعات وأقسام القبول والمشرفين، وفهم الردود الرسمية، وإنشاء الحسابات وتعبئة طلبات المنح والجامعات ورفع المستندات، وتجنب الأخطاء التي تسبب الاستبعاد، ثم متابعة الطلبات والمواعيد والنتائج بطريقة منظمة. والهدف أن يصبح الطالب قادرًا على تنفيذ عملية التقديم بنفسه دون الاعتماد على مكتب أو وسيط.',
      },
      {
        title: 'المقابلات والنتائج والتأشيرة وما بعد الحصول على المنحة',
        description:
          'الاستعداد لمقابلات واختبارات المنح والجامعات، وفهم القبول النهائي والمشروط وقائمة الانتظار والرفض، والتعامل مع النتائج، ثم تجهيز التأشيرة الدراسية ومقابلتها، والاستعداد للسفر والوصول والتسجيل في الجامعة، ومعرفة شروط المحافظة على المنحة بعد بدء الدراسة.',
      },
    ],
    learningOutcomes:
      'سيصبح الطالب قادرًا على البحث عن الفرص المناسبة، تقييمها واختيارها، تجهيز ملفه ووثائقه، كتابة الخطابات، اختيار الاختبارات المناسبة، التقديم بنفسه، متابعة طلباته، التعامل مع المقابلات والنتائج، ثم استكمال التأشيرة والسفر وبدء الدراسة والمحافظة على المنحة. الانتقال من مجرد معرفة الفرصة إلى تنفيذ عملية التقديم والقبول كاملة.',
  },
  {
    ...
    progressPercent: 0,
    courseContent:
      'دليل تدريبي شامل للتقديم على منحة الحكومة الصينية CSC والمنح الجامعية والمحلية، والتواصل مع المشرفين والحصول على خطابات القبول المبدئي.',
  },
  {
    ...
    progressPercent: 0,
    courseContent:
      'استراتيجيات تفكيك أقسام اختبار دولينجو، النماذج المتكررة، تقنيات التحدث والكتابة لتحقيق درجة 120+ للقبول الجامعي والمنح.',
  },
  {
    id: 'c-csca-exam',
    ...
    progressPercent: 0,
    courseContent:
      'تدريب مكثف على معايير وأسئلة اختبار CSCA ومهارات التحليل وحل التمارين التقييمية لضمان التفوق في ملف الترشح.',
  },
  {
    ...
    progressPercent: 0,
    courseContent:
      'توظيف أدوات ونماذج الذكاء الاصطناعي في صياغة الخطابات، مراجعة وتدقيق الأوراق الأكاديمية، والتحضير لمحاكاة المقابلات الشخصية.',
  },
];
