    ...
    courseModules: [
      {
        ...
        description:
          'فهم الفرق بين القبول الجامعي والمنحة الدراسية، وأنواع المنح الحكومية والجامعية والبحثية وغيرها، والفرق بين التمويل الكامل والجزئي، ومنح التبادل الثقافي، ومتطلبات المنح والجامعات، وكيفية تنظيم مواعيد التقديم والوثائق والاختبارات.',
      },
      {
